          ...
          <div className="max-w-3xl w-full">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-12">
              <div className="bg-white p-8 rounded-3xl border border-gray-200 shadow-sm text-center hover:border-blue-300 transition-colors group">
                ...
                <p className="text-gray-500 mb-6 text-sm">Requires 64-bit Windows</p>
                <div className="flex flex-col gap-2">
                  <a href={`/api/download-host-client?userId=${user?.id}`} download="mineforge-host.js">
                    <Button variant="primary" className="w-full bg-blue-600 hover:bg-blue-700 text-white">
                      <Download className="w-4 h-4 mr-2" />
                      Download Script
                    </Button>
                  </a>
                  <a href="/api/download-host-package" download="package.json">
            ...
            <div className="bg-blue-50 border border-blue-100 rounded-2xl p-6 mb-6">
              <h4 className="font-semibold text-blue-900 mb-2">How to run the client:</h4>
              <ol className="list-decimal list-inside text-sm text-blue-800 space-y-2">
                <li>Download both <code>mineforge-host.js</code> and <code>package.json</code> to a new folder.</li>
